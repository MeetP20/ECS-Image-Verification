...
- [ ] Support multiple public keys (multi-team or multi-environment signing)
- [ ] Slack webhook notifications alongside SNS
- [ ] Verify SBOM attestations using `cosign verify-attestation`
- [ ] AWS Security Hub integration for centralised findings dashboard
...
**Meet Prajapati** — DevOps Engineer  
[LinkedIn](https://www.linkedin.com/in/meet-prajapati-874286269) · [GitHub](https://github.com/MeetP20)